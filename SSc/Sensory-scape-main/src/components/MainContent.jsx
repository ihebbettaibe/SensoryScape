...
import child from "../assets/imagee.png"; // Ensure the image path is correct
...
const MainContent = () => {
  ...
  return (
    <main className="main-content font-sans">
      {/* Intro Section */}
      <section className="flex flex-wrap md:flex-nowrap items-center justify-between py-12 px-6 md:px-12 bg-gradient-to-r from-green-100 to-white">
        <div className="max-w-xl space-y-6">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            Welcome to our game designed to help autistic children understand
            and learn their emotions. Our platform offers an intuitive dashboard
            allowing specialists to choose the emotion on which the child will
            work.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed">
            Thanks to innovative tools such as a holographic projector, sensors,
            and actuators, the child is guided in identifying and accepting
            their emotions.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed">
            Our product is specially designed for therapy centers, providing a
            safe and secure environment to promote the emotional development of
            children with autism.
          </p>
          <button
            className="mt-6 py-2 px-6 bg-green-600 text-white font-semibold rounded-lg shadow-lg hover:bg-green-700 hover:shadow-xl transform transition-all duration-300"
        ...
        <div className="md:w-1/2 flex justify-end mt-6 md:mt-0">
          <img
            ...
            className="object-cover w-100s h-81 rounded-lg shadow-lg hover:scale-105 transform transition-all duration-300"
          />
        </div>
      </section>
