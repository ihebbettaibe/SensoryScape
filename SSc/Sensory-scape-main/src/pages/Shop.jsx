      ...
      <main className="py-10">
        <div className="shop-container max-w-screen-xl mx-auto px-6">
          ...
          <p className="text-center text-gray-600 mb-10 text-lg leading-relaxed">
            I accept to share data to enable more research and enhance our services.
          </p>
            ...
            {planDetails.map((plan, index) => (
              ...
              >
                ...
                >
                  ...
                  <h3 className={`text-2xl font-semibold mb-4 ${plan.titleClass}`}>
                    {plan.title}
                  </h3>
                  
                  {plan.title === "Subscription" && (
                    <p className="mb-4 text-white text-lg font-light">
                  ...
                  <ul className="space-y-2 mb-4 flex-grow">
                    {plan.features.map((feature, featureIndex) => (
                      <li key={featureIndex} className={`${plan.featureClass} text-lg`}>
                        {feature}
                      </li>
                    ))}
                  </ul>
