...
const About = () => {
  return (
    <div className="bg-gradient-to-r from-green-200 to-gray-300 text-gray-900 font-poppins">
      {/* Header Section */}
      ...
      <section className="container mx-auto px-6 py-16">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12 md:gap-16">
          ...
          <div className="md:w-1/2">
            <h2 className="text-4xl font-roboto font-semibold text-gray-800 leading-tight mb-4">
          ...
          <div className="md:w-1/2 flex justify-center mt-8 md:mt-0">
            <img
              ...
              className="w-full max-w-md md:max-w-lg shadow-lg rounded-lg"
            />
          </div>
        </div>
      </section>
